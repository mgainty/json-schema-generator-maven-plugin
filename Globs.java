...
public class Globs {
    ...
    public Globs(List<String> includes, List<String> excludes) {
        ...
        System.out.println("Globs::Globs LINE 47 excludes="+excludes);
        this.excludes = excludes == null ? new ArrayList<String>() : excludes;
        System.out.println("Globs::Globs LINE 49 excludes="+this.excludes);
    }
    ...
    public List<String> getExcludes() {
		System.out.println("Globs::getExcludes LINE 63 excludes="+excludes);
        return excludes;
    }
    ...
    public boolean equals(Object o) {
        ...
        System.out.println("Globs::equals LINE 75 excludes="+globs.excludes);
    ...
    public int hashCode() {
        ...
        System.out.println("Globs::Globs LINE excludes="+excludes);
